...
const data: BoardData = {
  ...
  "items": [
    ...
    },
    {
      ...
      "next": "Pricing/Labor: extract BidsPriceBookDrawer (P4 alone, re-mapped 2026-09-17 — keep applyPendingBookOffer in the tab), then the Labor parameter boxes (L4, Stage-A the string formulas first), then the grid (P2, optional). On the Stages map only the optional renderStagesFieldAndBillingLines component is left. The shared bid picker is a ~15-line sweep across fourteen tabs — a quiet-day mechanical sweep, not a train step.",
      "size": "L",
    ...
    },
    {
      ...
      "next": "PR 2 the bid-flow steps 11–12 Job opened / Job accounts in a new Won phase, the proxy rule, the accounts door — client-only, one guide paragraph.",
    ...
    },
    {
      ...
      "pointer": true,
      "summary": "The order to build the ready rows on the punch list, why, and where each one's plan and before/after mock-up live in this folder — so whoever picks this up cold starts from the same page.",
