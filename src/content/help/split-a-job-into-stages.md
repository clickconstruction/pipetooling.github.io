...
2. Press {{button:primary|Create invoice from remaining on N segments ($X)}} — it sits just below the Make Invoice chips. If any ticked stage is partly covered by an earlier dollar bill, that covered amount is subtracted and the helper text says so.
