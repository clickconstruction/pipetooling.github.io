...
Go to **pipetooling.com/fix** in your phone or computer browser and tap {{button:primary|Fix app}}. It clears the app's cached files and storage so the next load starts fresh. Then reload and sign in again.
