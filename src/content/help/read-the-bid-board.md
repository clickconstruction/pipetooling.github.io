...
- **Due Date** — a colored chip: the weekday + date on top, and a signed day count under it. **(+4)** means four days past due (red chip); **(-2)** means due in two days (amber when it's within three days). 
