...
- **Vehicle odometers** — vehicles held by a person with no odometer reading in over a week. Each row has the holder's name as a tap-to-call link, the last reading with its age, and a **Miles** box: call, type what they tell you, {{button:blue|Save}} — the reading lands on the vehicle's ledger and the row drops off. Motor pool and unassigned vehicles are skipped.
