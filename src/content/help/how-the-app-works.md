...
roles: all
keywords: overview, leaders, assistants, subs, projects, stages, sharing, mission
order: 1
---
...
**People** come in nine roles. **Leaders** (the master plumbers) run the work and the office. Office staff — **Assistants** and **Controllers** — work across the whole company; controllers also handle payroll. Field roles — **Subs** and **Helpers** — see only work assigned to them. **Estimators** live in Bids and Materials, **Primaries** are customer-side principals with billing visibility, **Superintendents** supervise their assigned projects, and **Devs** administer everything.

## The basic model

1. The company has **Customers** — one company, one book; nobody owns a customer
2. Customers can have **Projects**
3. Leaders assign People to **Project Steps**
4. When People complete Steps, the office is updated
...
- Every office role — leaders, assistants, controllers — sees every customer, project, job, bid and estimate. There is nothing to adopt or share; a new office hire sees the whole company on day one.
- Superintendents see the projects they are assigned to; primaries see their customer's money; field roles see their own jobs.
...
When a Leader or Assistant selects **Notify** on a step, that step shows up in their Subscribed Steps on the Dashboard.
