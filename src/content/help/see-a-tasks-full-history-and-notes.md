...
Tap the card again to close it. For repeating tasks, an event shows which day it belonged to (like "for Aug 19") whenever that isn't obvious from its own stamp. Very long-running tasks show the most recent 120 occurrences.
