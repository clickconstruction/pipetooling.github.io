...
keywords: counts, count sheet, plan page, audit, quick add, fixtures, duplicate, merge, totals
order: 95
---
...
Flip to By plan page, find "Plan page 26", and read straight against the sheet: 13 items, 158 units. Anything the drawing shows that the group doesn't have — add it right there with quick add.
:::
