...
**Under the bar, one line of words says where the job is.** Who was on site and when ("Behar & Malachi on site Sat", "3 on site today", "Texas Rooter on the sheet, no clock-ins", "nobody clocked in"), the percent and where it came from ("80% typed Sep 3", "12% reported Sep 11", "40% set Aug 7" for a number the job already carried when percent history began, "no % yet"), and the money ("$24,359 paid, nothing billed", "$32,108 billed, nothing paid"). The line turns **amber** when money is owed for work done or a bill is out unpaid, **green** when the job is paid in full, and **red** when a crew clocked in on a job that has no line items at all — nothing to bill against.
...
*Texas Rooter on the sheet, no clock-ins · 80% typed Sep 3 · $13,412 paid · $11,770 billed · $6,818 done, not billed*
:::
