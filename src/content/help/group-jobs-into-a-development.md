...
order: 74
---
When you're plumbing many houses in one subdivision, the jobs belong together — same builder, same streets, same phase. A **development** is a named group you can put jobs into, so you can find and review them as one unit instead of one job at a time.
