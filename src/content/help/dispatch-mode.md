...
- **Schedule** — a month calendar with dots on days that have work, and the selected day's agenda below: every person's blocks with time, duration, job, customer, address, and who's assigned. Tap a visit to open the job. A **person chip row** above the agenda isolates whoever you pick — tap one or more names, or **Everyone** to clear. The top-left corner shows the visible month with **‹ ›** arrows that slide the two-week strip across months, and **Today** brings you back. Each week row is labeled with its week number (w30, w31…) so you always know where you are. The blue **+** button opens **Assign work**: pick a job, tap a day, then tap people — each person shows a ribbon of their day so you can see who's free at a glance, and tapping a swim-lane name selects the whole crew. The app suggests times when **everyone selected is free** ("1:00–4:00 · all free"); pick one (or set a custom window — overlaps get an amber warning, but you can still schedule through them), add job instructions, choose whether the crew's blocks are **linked**, and hit Schedule. The {{icon:help|bell}} **bell** in the top-left sends a note to dispatch (it opens the Task Dispatch flow), and **Today** jumps back to today.
=======
