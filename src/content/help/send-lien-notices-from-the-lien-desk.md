...
- **Skip these months…** gives the lien right on those months up, on purpose, with a reason kept on the record. A skipped month does not vanish: it stays under the month cards as a dot in **Earlier months** — {{chip:green|Sent}}, {{chip:yellow|Skipped}} or {{chip:red|Missed}} — and clicking the dot opens the record: when it was skipped, by whom, the reason that was typed, and what it meant for the lien right.
