---
title: give someone a task
category: Office
roles: dev, master_technician, assistant, controller, primary, estimator, subcontractor, helpers
keywords: task, add task, assign, checklist, crew, team, send task, todo
order: 40
---
The **＋ Task button** in the top bar (the checkmark icon) opens the Add-task dialog from anywhere in the app. Type what needs doing, pick who does it, and {{button:blue|Save}} — the task lands on each person's **Checklist → Today** list on its day.
...
"Clean the shop bays" → tap **Farm crew** → Save. Four people get the task in two taps, and tomorrow the crew chip is still there for the next one.
:::
...
Reminders, notify-on-complete, and links to app pages live in the same dialog — set them and Save. To see or edit everything you've handed out, open **Checklist → Manage**.
