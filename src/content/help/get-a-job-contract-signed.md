...
One page on their phone: your letterhead, the job address, the work in plain words, the contract amount and payment line, and the terms one tap away. They type their full name (or switch to **Draw** and sign with a finger), tick the agreement box, and press a button that names the amount — {{button:blue|Sign agreement — $5,000.00}}. The page then shows the signed record with **Download signed PDF**, and emails them the signed agreement as a PDF; you and the job's leader get an email too, and the row turns {{chip:green|✍ Signed Sep 2 · M. Palmer}}.
