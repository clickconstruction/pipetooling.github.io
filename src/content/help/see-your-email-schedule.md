...
order: 60
---
PipeTooling can email you several different things — daily job report digests, the Billed Awaiting Payment report, your dispatch day, payment notifications, and GC statements you schedule from GC Review (those show on YOUR schedule with the destination address, since they usually go to an outside AP inbox). **My email schedule** shows all of it in one place, so you always know what's coming and when.
