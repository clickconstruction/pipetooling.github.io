...
- **Above or below their average** — a chart of every customer running off their own pace, worst first. The hollow dot is their 12-month average, the filled dot is where they are right now, and the dashed line is the company average — so "how far past their normal" and "how far past everyone's normal" are both visible at a glance. Red only appears when an open bill has already waited longer than that customer's own normal; green only when their recent payments actually beat it. Customers paying like they usually do collapse into one quiet line at the bottom.
