...
const note: ReleaseNote = {
  ...
  highlights: [
    ...
    'Every robot run is listed in plain words: the sealed runs on live bids at the top with the sealed-envelope steps a click away, and the practice runs on past bids under them. A run that didn’t count stays listed with the reason.',
  ],
}
