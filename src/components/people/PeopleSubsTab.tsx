...
/** Roster fields the bench reads (v2.2842): dates, notes, and when the row was added. */
...
export default function PeopleSubsTab() {
  ...
  // The bench (v2.2842): status per row from the roster dates + last worked; Active first.
