...
/** Roster fields the bench reads (v2.2836): dates, notes, and when the row was added. */
...
export default function PeopleSubsTab() {
  ...
  // The bench (v2.2836): status per row from the roster dates + last worked; Active first.
