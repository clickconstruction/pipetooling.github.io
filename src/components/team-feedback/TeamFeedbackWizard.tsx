        ...
        {[1, 2, 3, 4, 5].map((n) => (
          <button
            ...
            style={{
              ...
              background: value === n ? '#fff7ed' : 'var(--surface)',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                {managerEnabled && (
                  <button
                    ...
                    style={{
                      ...
                      background: includeManagerRatings ? '#fff7ed' : 'var(--surface)',
                      fontWeight: 600,
                      fontSize: '0.875rem',
                      color: 'var(--text-700)',
                      textAlign: 'left',
                ...
                {peerEnabled && (
                  <button
                    ...
                    style={{
                      ...
                      background: includePeerRatings ? '#fff7ed' : 'var(--surface)',
                      fontWeight: 600,
                      fontSize: '0.875rem',
                      color: 'var(--text-700)',
                      textAlign: 'left',
                ...
                <button
                  ...
                  style={{
                    ...
                    background: includeOpenComments ? '#fff7ed' : 'var(--surface)',
                    fontWeight: 600,
                    fontSize: '0.875rem',
                    color: 'var(--text-700)',
                    textAlign: 'left',
                  ...
                  {Array.from({ length: 10 }, (_, i) => i + 1).map((n) => (
                    <button
                      ...
                      style={{
                        ...
                        background: overall === n ? '#fff7ed' : 'var(--surface)',
