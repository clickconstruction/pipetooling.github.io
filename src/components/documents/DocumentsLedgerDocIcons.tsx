...
/** Filled document (e.g. accepted estimate with record). */
export function LedgerDocIconFilled(props: { className?: string }) {
  return (
    <svg {...iconBase} className={props.className}>
...
/** Outline document (e.g. sent estimate preview). */
export function LedgerDocIconOutline(props: { className?: string }) {
  return (
    <svg {...iconBase} className={props.className}>
...
/** Bid project folder (Drive). */
export function LedgerBidProjectFolderIcon(props: { className?: string }) {
  return (
    <svg {...iconBase} className={props.className}>
