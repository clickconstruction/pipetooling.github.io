 ...
 * Icon: helmet-safety (solid), native 640×640 viewBox. Marks the GC (General
 * Contractor) line on job rows (Stages Job column, Job Detail, Edit Job).
 */
...
export default function GcHardHatIcon({ size = 12, style }: Props) {
