 ...
 * Icon: address-card (solid), native 640×640 viewBox. Marks the customer line
 * on job rows (Stages Job column, Assigned Jobs, Builder Review, top-bar
 * search) — the same glyph those surfaces inline; extracted for the Edit-tab
 * Customer fact row (v2.1682).
 */
...
export default function CustomerContactCardIcon({ size = 13, style }: Props) {
