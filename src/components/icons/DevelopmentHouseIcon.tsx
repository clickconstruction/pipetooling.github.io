 ...
 * House-with-boundary icon (solid), native 640×640 viewBox. Marks the
 * Development (group of jobs) line on job rows (Stages Job column, Job
 * Detail, Edit Job) — the sibling of GcHardHatIcon for the GC line.
 */
...
export default function DevelopmentHouseIcon({ size = 12, style }: Props) {
