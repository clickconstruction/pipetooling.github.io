  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ margin: '0 0 0.25rem', fontSize: '0.9rem', color: '#0f172a' }}>
        ...
        {tab === 'pairs' ? (
          pairCounts.length === 0 ? (
            <div style={{ color: '#64748b', fontSize: '0.875rem' }}>No overlapping rule pairs.</div>
          ) : (
        ...
        {tab === 'transactions' ? (
          txRowsSorted.length === 0 ? (
            <div style={{ color: '#64748b', fontSize: '0.875rem' }}>No overlapping transactions.</div>
          ) : (
