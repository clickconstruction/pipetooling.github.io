/**
 * The portal globe glyph, drawn in `currentColor` so the ONE tint kernel
 * (`src/lib/portal/portalGlobeTint.ts`) colours it the same way beside a
 * customer and beside a sub (journey-map B18 / J21-F3).
 */
export default function PortalGlobeIcon({ size = 15 }: { size?: number }) {
  return (
