...
export default function SendRecordInvoiceModal({
  ...
  /**
   * The row the commit-time ensure returned (decision 17, v2.2885: the ensure
  ...
  /**
   * Decision 17 (v2.2885): the ensure RPC runs HERE — inside Send / Record,
  ...
  /** Measurement (ui_nav_clicks, v2.2885): a bill left the modal — payload kind + channel. */
