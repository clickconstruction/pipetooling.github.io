...
const FIXTURE_COLS = ['count', 'created_at', 'id', 'invoice_id', 'job_id', 'line_description', 'line_unit_price', 'name', 'sequence_order'] as const satisfies ReadonlyArray<keyof Row<'jobs_ledger_fixtures'>>
