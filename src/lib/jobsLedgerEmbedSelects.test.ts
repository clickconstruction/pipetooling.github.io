...
const FIXTURE_COLS = ['count', 'created_at', 'id', 'invoice_id', 'job_id', 'line_description', 'line_unit_price', 'name', 'sequence_order', 'shared_with_gc', 'stage_kind'] as const satisfies ReadonlyArray<keyof Row<'jobs_ledger_fixtures'>>
