 ...
 *
 * TWIN: `supabase/functions/_shared/accountingLabelAutoApprove.ts` must stay
 * byte-identical in behaviour — `accountingLabelAutoApproveSharedParity.test.ts`
 * fails when they drift. No imports here so the Deno copy stays a plain file.
 */
