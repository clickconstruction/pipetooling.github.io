...
describe('formatTimeSinceAgo', () => {
  it('buckets from "just now" through years with singular/plural forms', () => {
    ...
    expect(formatTimeSinceAgo(minus(28 * 86_400_000), NOW)).toBe('4 weeks ago')
    expect(formatTimeSinceAgo(minus(29 * 86_400_000), NOW)).toBe('4 weeks ago')
    expect(formatTimeSinceAgo(minus(30 * 86_400_000), NOW)).toBe('1 month ago')
