 ...
 *                (v2.3795 — read, never written; the chip names the reason)
...
export type ArDepositRowSlice = ArDepositTextSlice & {
  ...
  /** v2.3795: the bank returned it (Mercury `failed` after posting) — treated as returned without anyone marking it. */
