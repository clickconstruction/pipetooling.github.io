...
function job(over: Partial<GcNoticeJob>): GcNoticeJob {
  return { jobId: 'j', customerId: null, gcCustomerId: 'gc', isBilled: true, jobStatus: 'billed', claimAmount: 0, months: [], noticedMonths: [], ownerState: 'on_file', propertyKind: '', affidavitBy: '', item: null, readiness: 'ready', ...over }
}
