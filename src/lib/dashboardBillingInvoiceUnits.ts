...
export function mapJoinedInvoiceToDashboard(
  ...
  return {
    ...
    bill_to_stripe_customer_id: r.bill_to_stripe_customer_id,
    bill_to_party: r.bill_to_party,
    shown_to_party: r.shown_to_party,
    copy_emails: r.copy_emails,
