...
export const CUSTOMER_SURFACES: readonly SurfaceEntry[] = [
  ...
  { kind: 'sender', ref: 'sign-job-contract', audience: 'homeowner', steps: [H('job-contract-signed'), H('job-contract-signed-email')] },
  { kind: 'sender', ref: 'share-job-contract', audience: 'homeowner', steps: [H('job-contract-paper-email'), H('job-contract-signed-email')] },
