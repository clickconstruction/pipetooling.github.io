/**
 * APP TWIN of supabase/functions/_shared/signedAgreementEmail.ts — the staff email for the Signed agreements stream (v2.2743): a customer accepted an estimate,
