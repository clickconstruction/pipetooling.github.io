...
export type Database = {
  public: {
    Tables: {
      ...
      bids: {
        Row: { id: string; drive_link: string | null; plans_link: string | null; bid_submission_link: string | null; design_drawing_plan_date: string | null; gc_builder_id: string | null; customer_id: string | null; project_name: string | null; address: string | null; gc_contact_name: string | null; gc_contact_phone: string | null; gc_contact_email: string | null; estimator_id: string | null; bid_due_date: string | null; estimated_job_start_date: string | null; bid_date_sent: string | null; outcome: 'won' | 'lost' | 'started_or_complete' | null; loss_reason: string | null; bid_value: number | null; agreed_value: number | null; profit: number | null; distance_from_office: string | null; last_contact: string | null; notes: string | null; created_by: string; created_at: string | null; updated_at: string | null; selected_price_book_version_id: string | null; selected_labor_book_version_id: string | null; selected_takeoff_book_version_id: string | null }
        Insert: { id?: string; drive_link?: string | null; plans_link?: string | null; bid_submission_link?: string | null; design_drawing_plan_date?: string | null; gc_builder_id?: string | null; customer_id?: string | null; project_name?: string | null; address?: string | null; gc_contact_name?: string | null; gc_contact_phone?: string | null; gc_contact_email?: string | null; estimator_id?: string | null; bid_due_date?: string | null; estimated_job_start_date?: string | null; bid_date_sent?: string | null; outcome?: 'won' | 'lost' | 'started_or_complete' | null; loss_reason?: string | null; bid_value?: number | null; agreed_value?: number | null; profit?: number | null; distance_from_office?: string | null; last_contact?: string | null; notes?: string | null; created_by: string; created_at?: string | null; updated_at?: string | null; selected_price_book_version_id?: string | null; selected_labor_book_version_id?: string | null; selected_takeoff_book_version_id?: string | null }
        Update: { id?: string; drive_link?: string | null; plans_link?: string | null; bid_submission_link?: string | null; design_drawing_plan_date?: string | null; gc_builder_id?: string | null; customer_id?: string | null; project_name?: string | null; address?: string | null; gc_contact_name?: string | null; gc_contact_phone?: string | null; gc_contact_email?: string | null; estimator_id?: string | null; bid_due_date?: string | null; estimated_job_start_date?: string | null; bid_date_sent?: string | null; outcome?: 'won' | 'lost' | 'started_or_complete' | null; loss_reason?: string | null; bid_value?: number | null; agreed_value?: number | null; profit?: number | null; distance_from_office?: string | null; last_contact?: string | null; notes?: string | null; created_by?: string; created_at?: string | null; updated_at?: string | null; selected_price_book_version_id?: string | null; selected_labor_book_version_id?: string | null; selected_takeoff_book_version_id?: string | null }
        Relationships: []
      }
      bids_count_rows: {
      ...
      takeoff_book_entries: {
        Row: { id: string; version_id: string; fixture_name: string; alias_names: string[] | null; sequence_order: number; created_at: string | null }
        Insert: { id?: string; version_id: string; fixture_name: string; alias_names?: string[] | null; sequence_order?: number; created_at?: string | null }
        Update: { id?: string; version_id?: string; fixture_name?: string; alias_names?: string[] | null; sequence_order?: number; created_at?: string | null }
        Relationships: []
      }
      takeoff_book_entry_items: {
        Row: { id: string; entry_id: string; template_id: string; stage: string; sequence_order: number; created_at: string | null }
        Insert: { id?: string; entry_id: string; template_id: string; stage: string; sequence_order?: number; created_at?: string | null }
        Update: { id?: string; entry_id?: string; template_id?: string; stage?: string; sequence_order?: number; created_at?: string | null }
        Relationships: []
      }
    }
