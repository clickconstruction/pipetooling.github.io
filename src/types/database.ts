  ...
  public: {
    Tables: {
      ...
      billed_report_email_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "billed_report_email_requests_recipient_user_id_fkey"
            columns: ["recipient_user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "billed_report_email_requests_requested_by_fkey"
      ...
      payment_forecast_email_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "payment_forecast_email_requests_recipient_user_id_fkey"
            columns: ["recipient_user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "payment_forecast_email_requests_requested_by_fkey"
            columns: ["requested_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
