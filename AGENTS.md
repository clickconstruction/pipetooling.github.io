...
| Salaried workday **end-time hints** (Day end / session ends, `+1 day`), **split** first-block default; **`salary_sync`** continuous duplicate INSERT guard (`20270402100000`); indexed-slot **split RPCs** + split-mode **overlap** guard (`20270403180000`); runbook **`SALARY_CLOCK_SESSIONS.md`** | `RECENT_FEATURES.md` → v2.229, v2.228; `MIGRATIONS.md` → `20270402100000`, `20270403180000`; `SalaryWorkScheduleSettings.tsx`; `salaryScheduleEndTimeDisplay.ts` |
