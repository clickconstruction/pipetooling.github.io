...
| Dashboard **Assigned Jobs** / **Superintendent Jobs** (title → **Job Detail**), **team Ready to Bill** (`list_ready_to_bill_assigned_jobs_for_dashboard`), subcontractor **Collect Payment** coming soon, in-progress stage banner, Choose from my jobs | `RECENT_FEATURES.md` → v2.338, v2.142; `PROJECT_DOCUMENTATION.md` → Dashboard; `MIGRATIONS.md` → `20260419154440_list_ready_to_bill_assigned_jobs_for_dashboard`, 20260624000000_allow_superintendent_send_to_billing |
