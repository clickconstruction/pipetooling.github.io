...
Status: **not started** · planned 2026-09-14 · 6 owner decisions open (below) · mock-up: [`mockup.html`](./mockup.html) (entry points, Draft A, the critique, Refined B: office pane, leader pane + phone, the run; also published as a Claude artifact 2026-09-14) · spine: the v2.3400 work-months kernel (`src/lib/jobs/forecastWorkMonths.ts`)
