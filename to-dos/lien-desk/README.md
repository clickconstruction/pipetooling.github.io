...
Status: **in progress** · PR 1 v2.3405 (the migration, the queue kernel, the desk's office and leader sides, the doors, the Dashboard cards) · PR 2 v2.3410 (the run) · PR 3 v2.3412 (affidavits + the Legal desk hand-off) — **everything in the plan is built**; delete this to-do once the three PRs are merged and both migrations pushed · the 6 decisions below taken as proposed on 2026-09-14 ("this should work, please build it all") · mock-up: [`mockup.html`](./mockup.html) (entry points, Draft A, the critique, Refined B: office pane, leader pane + phone, the run; also published as a Claude artifact 2026-09-14) · spine: the v2.3400 work-months kernel (`src/lib/jobs/forecastWorkMonths.ts`)
