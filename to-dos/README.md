...
|---|---|---|
| [`stage-plan/`](./stage-plan/README.md) | **in progress** · PRs 1–3 shipped · PR 4 (v2.3128) + PR 5 (v2.3132) in flight · PR 6 (guides) next | The line item is the stage: Order / Any / — on the Bill tab, generator kinds, Edit read-out + customer drawer, the GC card as a simple sequence with no sub names. Six-PR train, mock-ups inside. |
