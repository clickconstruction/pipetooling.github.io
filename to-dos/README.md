...
|---|---|---|
| [`review-into-the-bridge.md`](./review-into-the-bridge.md) | in progress · step 1 shipped v2.3360 | People → Review folds into the Bridge: one earned convention (shipped), the Vectors row as the door (next), retire Team Summary once the tables agree (gated). Teammates get money-free Needs You items only. |
