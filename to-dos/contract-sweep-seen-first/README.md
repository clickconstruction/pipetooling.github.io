...
Status: **in progress** · PR 0 v2.3384 (the floor + Not needed, #3114) · PR 0c v2.3385 (the job-form door, #3115) · PR 1 v2.3386 (the readiness kernel + list, #3116) · PR 2 v2.3387 (the pane, #3117) · PR 3 v2.3388 (editing in place) · next: PR 4 filing → last, the Drive pass (the owner connects Drive first) · mock-up: [`mockup.html`](./mockup.html) (the brief with mock-ups A–D, also published as a Claude artifact 2026-09-13)
