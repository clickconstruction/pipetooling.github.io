/**
 * Letterhead identity for the customer portal (portal train PR 1). One
 * place to update when the license line or office phone changes; the page
 * hides any empty field.
 */
