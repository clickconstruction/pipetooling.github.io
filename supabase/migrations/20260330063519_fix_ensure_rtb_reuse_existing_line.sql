-- When a draft ready_to_bill line already holds the full balance, v_unalloc is 0 but
-- v_inv_amount is positive — return success reusing that row instead of erroring.
