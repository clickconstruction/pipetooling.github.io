-- Collect payment certify payload: billing customer email/name for step 3 display.
...
COMMENT ON FUNCTION public.get_collect_payment_certify_payload(uuid) IS
  'Subcontractor: billable fixtures + RTB invoice + flow + collect_invoice + billing_customer (job snapshot for step 3).';
