...
--
-- NOTE: applied to prod 2026-07-03 via MCP (ledger version 20260703194625); this file
-- was recovered from branch chore/salaried-cleanup (where it was numbered 20260704150000,
-- colliding with job_collections_flag) and renamed to match the remote ledger.
