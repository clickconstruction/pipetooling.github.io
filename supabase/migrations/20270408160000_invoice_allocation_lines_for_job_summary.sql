-- Job Summary Parts Cost: per-invoice allocation lines (same job visibility as get_invoice_amounts_for_jobs)
...
COMMENT ON FUNCTION public.get_invoice_allocation_lines_for_jobs(uuid[]) IS
  'Per-invoice lines allocated to jobs for Job Summary Parts Cost. Visibility matches get_invoice_amounts_for_jobs.';
