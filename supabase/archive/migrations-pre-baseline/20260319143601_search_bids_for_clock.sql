-- Search bids for Clock In modal. Respects bids RLS via SECURITY INVOKER.
...
COMMENT ON FUNCTION public.search_bids_for_clock(TEXT, UUID) IS 'Search bids by project name, address, or customer/GC name. Used by Clock In modal for bid association. Filters by service_type_id.';
