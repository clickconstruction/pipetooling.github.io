-- Add mercury_debit_card_id to list_my_linked_mercury_transactions_for_tally for Job Tally per-card filtering.
...
COMMENT ON FUNCTION public.list_my_linked_mercury_transactions_for_tally() IS
  'Linked-card transactions for Tally: includes mercury_debit_card_id for filtering, raw and job_splits for allocation UI.';
