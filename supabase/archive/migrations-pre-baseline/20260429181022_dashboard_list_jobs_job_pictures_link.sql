-- Dashboard team job rows: expose jobs_ledger.job_pictures_link for Job Pictures link under address.
...
COMMENT ON FUNCTION public.list_assigned_jobs_for_dashboard() IS
  'Team working jobs for dashboard. Includes job_pictures_link. last_report_at = any author; my_last_report_at = current user Leave Report nag.';
...
COMMENT ON FUNCTION public.list_ready_to_bill_assigned_jobs_for_dashboard() IS
  'Ready-to-bill team jobs for dashboard. Includes job_pictures_link.';
...
COMMENT ON FUNCTION public.list_superintendent_jobs_for_dashboard() IS
  'Superintendent project-linked jobs for dashboard. Includes job_pictures_link and my_last_report_at.';
