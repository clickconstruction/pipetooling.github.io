-- Replaces salary split RPC bodies to use people_hours_subtract_approved_hours (person_id-aware).
-- Generated from 20270403180000_salary_split_indexed_segments_overlap_sync_guard.sql logic.
...
-- When salary_work_schedule_templates row is removed (e.g. user switched to hourly),
-- delete non-final salary_schedule clock_sessions for that user/day so sync can clear orphans.
