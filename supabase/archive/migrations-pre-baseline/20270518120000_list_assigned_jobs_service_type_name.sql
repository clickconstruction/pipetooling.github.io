-- After 20270507120000_dashboard_my_last_report_at: restore Dashboard columns dropped there (job_pictures_link,
-- service_type_id) and add service_type_name for trade tags. Applies last so it wins over earlier list_assigned defs.
...
COMMENT ON FUNCTION public.list_assigned_jobs_for_dashboard() IS
  'Team working jobs for dashboard. last_report_at = any author; my_last_report_at = current user. job_pictures_link, service_type_id, service_type_name.';
