-- PL/pgSQL: variable `cs` (DECLARE cs record) shadowed table alias `cs` in NOT EXISTS subqueries,
-- so `cs.user_id` resolved to the record (missing field) instead of clock_sessions.user_id.
-- Rename inner query alias to `sess` (same body as 20270410130200 otherwise).
