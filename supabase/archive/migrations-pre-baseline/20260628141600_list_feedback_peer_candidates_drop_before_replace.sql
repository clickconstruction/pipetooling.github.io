-- Postgres cannot change RETURNS TABLE columns with CREATE OR REPLACE alone; drop first when upgrading from older signature.
...
COMMENT ON FUNCTION public.list_feedback_peer_candidates() IS
  'Peer picker: people (roster, links, shares) plus user-only team members without a people row; capped at 5000.';
