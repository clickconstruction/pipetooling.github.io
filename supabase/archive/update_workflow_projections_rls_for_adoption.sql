-- Update workflow_projections RLS policies so that:
-- - Devs and masters can manage projections for workflows on projects they can access
-- - Assistants can see projections for projects they have access to (via adoption), but cannot modify them
--
-- This mirrors the access model used for project_workflows and projects.
