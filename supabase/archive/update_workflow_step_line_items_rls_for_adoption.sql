-- Update workflow_step_line_items RLS policies so that:
-- - Devs and masters can manage line items for steps on projects they can access
-- - Assistants can see and edit line items for projects they can access (via adopted masters)
-- - Subcontractors cannot see or modify these private line items
--
-- This mirrors the access model used for workflow_projections and projects.
