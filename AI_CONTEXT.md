...
- **4 Major Systems** (+ significant subsystems):
  ...
  - **Prospects** (lead management, Convert tab, callbacks; **Team** activity in **`prospectTeamActivity`**) and **Quickfill** (billing workflow, **Banking sorting** snapshot, **Prospects** section — warmth + Team table + link — **`QuickfillProspectsSection`**, Crew Jobs / Bids with Realtime **`CrewJobsBlock`**) are major subsystems
