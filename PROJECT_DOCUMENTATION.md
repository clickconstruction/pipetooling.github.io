...
### 5. People Roster
- **Page**: `People.tsx`
- **Tabs**: **Users** (default), **Pay History**, **Pay**, **Hours**, **Team Costs**, **Vehicles**, **Housing**, **Offsets**, **Review** (dev-only), **Feedback** (dev-only; URL **`?tab=feedback`**)
- **Features**:
