...
- **RLS**: Leaders and members can read rows they appear on; dev, master_technician, and assistant can manage all rows (Settings UI). **SQL:** `is_team_lead_for_member(leader, member)`, `can_manage_team_leader_assignments()`.
