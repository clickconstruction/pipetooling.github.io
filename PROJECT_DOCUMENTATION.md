...
- **Features**:
  ...
  - List people by kind (Assistant, Master Technician, Subcontractor, Estimator) merged with matching user accounts
  ...
  - **Pay Report** (pay stub document): Date | Hours | **Jobs / Bids** from `people_crew_jobs` / `people_crew_bids`; **Gross Pay**, optional itemized **Additional** (`pay_stub_additional_lines`), **Less** and **Net Pay**; pending offsets FYI; **Physical payments** footer from `pay_stub_payments` (amount, date, memo, total).
