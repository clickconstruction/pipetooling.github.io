...
| `gc_statement` | scheduled report | `gc_statement_email_requests` (v2.1426; free-text `sent_to`; scheduling UI v2.1427; **office-wide SELECT since v2.2881**, Cancel requester-or-dev) | `gc-statement-email-dispatch` (send-time dedupe v2.2881) | ✅ requester-scoped (v2.1428) | — (scheduled report, not an event stream) |
