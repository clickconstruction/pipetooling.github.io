...
| `check_edge_boot` | OPTIONS-probes every edge function (a generated list) and names any answering `503 BOOT_ERROR` — deployed but unable to start, which `check:edge-drift` cannot see. |
