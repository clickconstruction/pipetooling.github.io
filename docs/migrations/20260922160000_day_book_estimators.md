# 20260922160000_day_book_estimators.sql (2026-09-22, v2.3727)

**Purpose**: estimators on the Day book, and the estimating strip (Day book PR 4).

**Changes** — `CREATE OR REPLACE FUNCTION public.get_day_book_payload(date, date, uuid)`, the body of `20260922150000_schedule_block_events.sql` (PR 5) with:
...
**Idempotent**: `CREATE OR REPLACE`; grants unchanged. Additive. **Order**: after `20260922150000` (PR 5).
