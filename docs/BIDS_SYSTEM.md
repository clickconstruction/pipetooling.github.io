...
- **Field order** (sectioned form since the v2.1839 redesign — see `RECENT_FEATURES.md` **v2.1839** for the full map):
  ...
  8. **Money** section (Bid Value | Agreed Value | Maximum Profit), **Notes**, then the **sticky save bar** (Delete bid… quiet-left, Archive from board, required hint, Save and Open Counts, Save)
