...
> PR 10's publish step is done: the Direct Deposit Authorization was published through the Form Studio 2026-09-06 after six review rounds, and the four Texas § 53.284 lien waivers went live 2026-09-07 with the pay-row picker (v2.3062). The to-do that tracked the step retired then.
