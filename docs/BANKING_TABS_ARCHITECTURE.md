...
12. **Two assignment-load strategies for the same table**: Accounting does one unfiltered select `.limit(100000)`; Drag Sort chunks 400-id `.in()` batches. Both intentional at their respective row scales — don't unify during a move.
