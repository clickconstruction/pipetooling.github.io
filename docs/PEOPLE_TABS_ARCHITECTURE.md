...
Tabs switch on a single `activeTab` state ([`People.tsx`](../src/pages/People.tsx), search `useState<PeopleTab>`). The `PeopleTab` type — **18 keys** — lives in [`src/lib/people/peopleTabGroups.ts`](../src/lib/people/peopleTabGroups.ts) since v2.2811 (Subs landed v2.1214, Teams removed v2.1292 with `?tab=teams` redirecting to Users, HR v2.2221, Person v2.2710):
