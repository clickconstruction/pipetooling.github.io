...
5. **The file layout is:** module helpers/types (~1–289) → state block (~296–900, every `useState`/`useRef` in the component is declared here) → stages memos + mutation engine (~903–1360) → loaders + Sub Labor CRUD (~1370–2429) → print builders (~2430–3150) → URL router + effects (~3160–3860) → parts/mercury callbacks + memos + job-form glue (~3860–4630) → tab bar (~4638–4820) → per-tab JSX (~4822–8770; Stages is ~4841–8400) → modal tail (~8771–10684). Line numbers are "as of v2.819" and rot — search symbols.
