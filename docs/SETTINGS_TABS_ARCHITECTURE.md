...
4. **People/Jobs residue** — split into two halves:
   ...
   - 4b (pending): merge-duplicates modal + handlers into SettingsPeopleTab; `useSettingsPeopleDirectory` for groups (dispatch/estimator toggles), pay-approved, and people (myPeople/nonUserPeople + person edit/delete) handlers.
