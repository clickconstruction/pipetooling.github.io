...
- **Render:** `SettingsGroup id="settings-templates"`, dev-only → [`SettingsTemplatesTab`](../src/components/settings/SettingsTemplatesTab.tsx) (props: `authUser`, `users`, `setError`).
