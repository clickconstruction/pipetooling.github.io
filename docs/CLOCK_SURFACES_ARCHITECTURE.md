...
- **Sub-components:** [`TallyPreClockOutModal`](../src/components/tally/TallyPreClockOutModal.tsx), [`AdditionalReportModal`](../src/components/AdditionalReportModal.tsx) (overlayZIndex 1100), [`TeamFeedbackWizard`](../src/components/team-feedback/TeamFeedbackWizard.tsx) — all **extracted**; the review modal is **inline**.
