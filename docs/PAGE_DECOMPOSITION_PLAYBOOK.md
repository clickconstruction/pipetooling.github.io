...
| `src/pages/Settings.tsx` | 4,564 | map written ([`SETTINGS_TABS_ARCHITECTURE.md`](./SETTINGS_TABS_ARCHITECTURE.md)) — extraction underway (Sharing & Adoption out in v2.853) |
