...
| `src/pages/Settings.tsx` | 2,435 | map written ([`SETTINGS_TABS_ARCHITECTURE.md`](./SETTINGS_TABS_ARCHITECTURE.md)) — extraction underway (v2.853–v2.856: Sharing & Adoption, Templates, Catalogs, Jobs/Advanced/prospects) |
