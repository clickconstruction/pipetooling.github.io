...
| `src/pages/Settings.tsx` | 2,121 | map written ([`SETTINGS_TABS_ARCHITECTURE.md`](./SETTINGS_TABS_ARCHITECTURE.md)) — extraction underway (v2.853–v2.857: Sharing & Adoption, Templates, Catalogs, Jobs/Advanced/prospects, People directory) |
