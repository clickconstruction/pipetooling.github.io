...
- **Phase**: This is Phase 1 (capture) — deletions become recoverable-from-data immediately. Phase 2 will add dev-only `list_deleted_records`/`restore_deleted_records` RPCs and a "Recently deleted" view in the dev-only **Settings → Data & migration** tab.
