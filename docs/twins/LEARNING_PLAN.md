...
| 6 | Holdout set flag + holdout-only gate denominators | app + owner decision | mechanism shipped v2.2942 + harness enforcement v2.2945 (open_backtest refuses; next_backtest skips; gate_run override); WHICH references still needs the owner (Queue lens toggle, target 20–25) |
