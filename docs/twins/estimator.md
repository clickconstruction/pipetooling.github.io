...
type: Twin brief
role: estimator
purpose: Everything a limited-context agent needs to work as an estimator in PipeTooling. Pair with docs/twins/APP_DIRECTORY.md for navigation and /help?g=<slug> guides for step-by-step how-tos.
audience: Digital Twins
last_updated: 2026-08-28
token_budget: ~3.5k core
---
...
bid), count the fixtures from the plans, price the work, send a proposal letter, chase the
...
date, ITB links; then Counts → Takeoff → Pricing → Cover Letter. Guides:
...
## 6 · Guardrails and self-verification
