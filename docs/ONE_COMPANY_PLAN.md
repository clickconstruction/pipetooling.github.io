...
- **Phase 2** — next: the inline-compare policy sweep (merges alone).
- **Phase 3** — after Phase 2: owner pickers go, "leader" copy, docs rewrite.
