...
- **`src/pages/Prospects.tsx`** - Lead management; top-level **Customers** tab groups sub-tabs Follow Up / Prospect List / Convert / **Activity** (formerly "Team"; dev/assistant); legacy `?tab=team` → `?tab=activity` (**v2.708**)
