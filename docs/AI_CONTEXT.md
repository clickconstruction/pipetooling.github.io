...
- **`src/pages/Prospects.tsx`** - Lead management; top-level **Customers** tab groups sub-tabs Follow Up / Prospect List / Convert / **Activity** (formerly "Team"; dev/assistant) (**v2.708**); top-level **Team** tab = prospective-hires pipeline (`?tab=team`, **`team_prospects`** table, drag-ranked via [`teamProspectRanking.ts`](../src/lib/teamProspectRanking.ts) + [`TeamProspectsTab.tsx`](../src/components/prospects/TeamProspectsTab.tsx), **v2.709**)
